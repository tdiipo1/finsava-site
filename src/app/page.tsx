      ...
      <footer className="border-t border-[var(--card-border)] py-8 px-6">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 sm:flex-row">
          ...
          <div className="flex items-center gap-4">
            ...
            {/* X/Twitter — update href when account is created */}
            ...
            {/* Discord — update href when server is created */}
            <a href="https://discord.gg/finsava" target="_blank" rel="noopener noreferrer"
              className="text-[var(--muted)] hover:text-white transition-colors" aria-label="Discord">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
